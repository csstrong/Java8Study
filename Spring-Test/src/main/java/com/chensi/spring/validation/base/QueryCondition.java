...
public class QueryCondition implements Serializable {
	...
	public QueryCondition(String FieldName, Object value, FieldType type) {
	...
	public QueryCondition(String FieldName, Object value, FieldType type, Relational relational) {
		_fieldname = FieldName;
		_value = value;
		_ischanged = true;
		_type = type;
		_RelationalOptor = relational;
	}

	public QueryCondition(String FieldName, FieldType type) {
		_fieldname = FieldName;
		_value = null;
		_type = type;
	}
	...
	public QueryCondition(final FieldAttribute fd) {
		if (fd == null) {
			return;
		}
...
//    }
	...
	@Override
	public String toString() {
		return new StringJoiner(", ", QueryCondition.class.getSimpleName() + "[", "]")
			.add("_fieldname='" + _fieldname + "'")
			.add("_alias='" + _alias + "'")
			.add("_prefix='" + _prefix + "'")
			.add("_type=" + _type)
			.add("_value=" + _value)
			.add("_value2=" + _value2)
			.add("_ischanged=" + _ischanged)
			.add("_Orderby=" + _Orderby)
			.add("_selectfield=" + _selectfield)
			.add("_groupfield=" + _groupfield)
			.add("_jionto=" + _jionto)
			.add("_readonly=" + _readonly)
			.add("_RelationalOptor=" + _RelationalOptor)
			.toString();
	}
}
