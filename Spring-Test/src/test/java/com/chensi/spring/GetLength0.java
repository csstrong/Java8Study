...
public class GetLength0 {
	...
	public static void main(String[] args) {
		String str9 = "QN=20231120102138000;ST=22;CN=9015;PW=123456;MN=2018112301;Flag=4;CP=&&DataTime=20231120102138000;;&&";
		...
		System.out.println("str is " + strCheckCode);
		System.out.println("str len " + str9.length());
		try {
