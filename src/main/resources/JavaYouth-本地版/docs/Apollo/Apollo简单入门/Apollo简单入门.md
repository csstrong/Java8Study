...
![image-20201228102339176](image/0012.png)
...
![image-20201228103939300](image/0022.png)
...
<img src="image/0029.png" style="zoom:67%;" />
...
![image-20201228112150602](image/0034.png)
...
1.  从其他集群同步已有配置到新集群
    ...
    *   展开要同步的Namespace，点击同步配置
    ...
    ![image-20201228112603903](image/0037.png)
...
<img src="image/0056.png"/>

2. 切换到`配置`Tab，再次检查灰度的配置部分，如果没有问题，点击`灰度发布`

<img src="image/0057.png" />
...
<img src="image/0058.png"/>

<img src="image/0059.png" />
